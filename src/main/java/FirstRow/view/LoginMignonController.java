	...
	private void handleImput() {
		...
		if(utenteEsistente(x,y)){
			try {
			        ...
			        loader.setLocation(getClass().getResource("view/RispostaLoginSuccesso.fxml"));
			...
			try {
		        	// Load the fxml file and create a new stage for the popup dialog.
		        	FXMLLoader loader = new FXMLLoader();
		        	loader.setLocation(getClass().getResource("view/RispostaLoginInsuccesso.fxml"));
		        	AnchorPane page = (AnchorPane) loader.load();
		...
		if(ok) {
			...
			try {
				// Load the fxml file and create a new stage for the popup dialog.
					FXMLLoader loader = new FXMLLoader();
			        loader.setLocation(getClass().getResource("view/AttivitaCompletate.fxml"));
